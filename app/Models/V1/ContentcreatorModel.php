...
class ContentCreatorModel extends Model
{
    ...
    /**
     * Get list of content creators (role_id = 3)
     */
    public function getContentCreators($data)
    {
        ...
        $builder->where('u.role_id', 3); // Content Creator role
        ...
        foreach ($results as $key => $creator) {
            $results[$key]['mobile'] = [];
        }
